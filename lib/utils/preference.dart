...
class Preference {
  ...
  static Future<String> getString(String key, {required String def}) async {
    return (await load()).getString(key) ?? def;
  }

  static Future<int> getInt(String key, {required int def}) async {
    return (await load()).getInt(key) ?? def;
  }

  static Future<double> getDouble(String key, {required double def}) async {
  ...
  static Future<List<String>> getStringList(String key,
      {required List<String> def}) async {
